...
export default async function EquipmentPage({
  ...
  const petrovResume = `<b>Петров Артём Николаевич</b>
    <ul>
  ...
  const kazakovOrlovResume = `<b>Казаков Александр Иванович · Орлов Александр Николаевич</b><br><span style="color:var(--ink-2)">Инструкторы учебной базы «Технотранс» (г. Курган)</span>
