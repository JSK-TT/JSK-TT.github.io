...
export default async function EquipmentPage({
  ...
  if (e.program && !e.progWork) {
    ...
    if (e.program.combined) progBlocks.push({ title: "Программа · Оператор-механик", items: e.program.combined });
  }
  ...
  const resumeHtml = isKuz
    ? kuznetsovResume
    : isBurlak
      ? `<b>Механик-испытатель завода Бурлак</b><br>Практические инструктажи на серийной технике на территории и полигоне завода Бурлак (г. Курган). Эксплуатация, обслуживание и ремонт вездеходной техники «Бурлак 6×6».`
      : `<b>Казаков А. И. / Орлов А. Н.</b><br>Инструкторы учебной базы Технотранс (г. Курган). Практические инструктажи операторов и механиков по спецтехнике на закрытой учебной площадке.`;
    ...
    <>
      <div className="crumbs">
        <div className="wrap">
          ...
          <Link href="/">Инструктажи по спецтехнике</Link> → <b>{e.title}</b>
        </div>
      </div>
